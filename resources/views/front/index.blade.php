					...
					<div class="accordion accordion-flush accordion-1" id="accordionFlushExample">
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="flush-heading{{ $service -> id}}">
								<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse{{$service->id}}" aria-expanded="@if($index==0) true @endif" aria-controls="flush-collapse{{$service->id}}">
									{{ $service -> name }}
								</button>
							</h2>
							<div id="flush-collapse{{$service->id}}" class="accordion-collapse collapse @if($index==0) show @endif" aria-labelledby="flush-heading{{$service->id}}" data-bs-parent="#accordionFlushExample">
