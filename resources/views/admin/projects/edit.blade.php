...
<div class="card card-solid">
    <div class="card-body">
        <div class="row">
            ...
            <form class="col-12 dropzone" action="{{ route('admin.projects.update', $project -> id) }}" method="post"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        ...
                        <select name="category_id" class="form-control">
                            ...
                            <option value="{{ $category -> id }}" {{ $project->category->id === $category -> id ?  'selected' : ''}}>{{ $category -> name }}</option>
                            @endforeach
                        </select>
                    </div>
