...
<li class="breadcrumb-item"><a href="{{ route('dashboard.branches.index') }}">Branches</a></li>
...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <form class="col-12" action="{{ route('dashboard.branches.store') }}" method="post"
