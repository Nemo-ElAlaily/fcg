...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        <form action="{{ route('dashboard.offices.index') }}" method="get">
            ...
            <table class="text-center pt-2 card-body table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('dashboard.offices.show', $office->id) }}"
                                class="btn btn-square btn-info btn-sm">
                                <i class="fa fa-eye fa-lg text-lg"></i>
                            </a>
                            <a href="{{ route('dashboard.offices.edit', $office->id) }}"
                                class="btn btn-square btn-sm btn-success"><i class="fa fa-pen"></i></a>
                            <form action="{{ route('dashboard.offices.destroy', $office->id) }}" method="post"
