...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <form class="col-12" action="{{ route('dashboard.offices.update', $office->id) }}" method="post"
            ...
            <div class="card-body row">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12 custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input form-control" id="is_active" name="is_active" {{$office->is_active ? 'checked' : ''}}>
                            <label class="custom-control-label" for="is_active">Active</label>
                        </div>

                        <div class="form-group col-md-6">
                            <label for="name">Office Title</label>
                            @error('title')
                            <span class=" text-danger">{{ $message }}</span>
                            @enderror
                            <input type="text" class="form-control" id="title" placeholder="Service title"
                                value="{{ $office -> title }}" name="title">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="container">
                                    <img src="{{ $office -> image_path }}" width="100px"
                ...
                <div class="">
                    <button type="submit" class="btn btn-primary w-100">Update Office</button>
                </div>
            </div>
        </form>
