        ...
        <div class="row m-5">
            ...
            <div class="col-md-6 my-1">
                <button type="submit" class="btn btn-square btn-outline-primary btn-sm"><i class="fa fa-search"></i>
                    Search</button>
                <a href="{{ route('dashboard.pages.create') }}" class="btn btn-square btn-outline-secondary btn-sm"><i
            ...
            <table class="text-center pt-2 card-body table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('dashboard.pages.show', $page->id) }}" class="btn btn-square btn-info btn-sm">
