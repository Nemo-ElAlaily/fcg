...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <form class="col-12" action="{{ route('dashboard.services.update', $service->id) }}" method="post"
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12 custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input form-control" id="is_active" name="is_active" {{$service->is_active ? 'checked' : ''}}>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="container">
                                    <img src="{{ $service -> image_path }}" width="100px"
