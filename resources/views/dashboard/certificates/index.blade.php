            ...
            <div class="row m-5">
                ...
                <div class="col-md-6 my-1">
                    ...
                    <a href="{{ route('dashboard.certificates.create') }}"
                        class="btn btn-square btn-outline-secondary btn-sm"><i class="fa fa-plus"></i> Add Certificate</a>
                </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('dashboard.certificates.destroy', $certificate->id) }}" method="post"
